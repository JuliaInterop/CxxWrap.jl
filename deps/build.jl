...
download_info = Dict(
    ...
    Windows(:i686, compiler_abi=CompilerABI(:gcc8,:cxx11)) => ("$bin_prefix/libcxxwrap-julia-1.0.v0.5.0.i686-w64-mingw32-gcc8.tar.gz", "40653ca3ce1bc46950c4dc9c4867d230b8f27dba1ab6f504d7f8ac1a47de9e0e"),
    ...
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7,:cxx11)) => ("$bin_prefix/libcxxwrap-julia-1.0.v0.5.0.x86_64-linux-gnu-gcc7.tar.gz", "241fcb0422271aaeda7347aef8dbf6b0c683f395f4670d522d53bcad75fdb1d4"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8,:cxx11)) => ("$bin_prefix/libcxxwrap-julia-1.0.v0.5.0.x86_64-linux-gnu-gcc8.tar.gz", "c15a4be72fffff69184e16c0e8dd3a7350b5018cfa6bd5605e14bc5af9096ca2"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc7,:cxx11)) => ("$bin_prefix/libcxxwrap-julia-1.0.v0.5.0.x86_64-w64-mingw32-gcc7.tar.gz", "d78dead3fff50956597cec350cce78b74f455259ab02f8ebe54562aa69a7174d"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc8,:cxx11)) => ("$bin_prefix/libcxxwrap-julia-1.0.v0.5.0.x86_64-w64-mingw32-gcc8.tar.gz", "948d274083a523c4132bc0ca4f61839acc52b98afeaeca30243d1321445fbfeb"),
)
