...
const prefix = JLCXX_LIBDIR == "" ? Prefix(joinpath(@__DIR__, "usr")) : JLCXX_LIBDIR
...
#   provides(Binaries, Dict(joinpath(JLCXX_LIBDIR,"examples") => deps))
# end
...
# lib_suffix = @static Sys.iswindows() ? "dll" : (@static is_apple() ? "dylib" : "so")
